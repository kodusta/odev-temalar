                        ...
                        <div className="swiper-container slider__active">
                            <div className="slider-wrapper swiper-wrapper">
                                <div className="single-slider swiper-slide slider-height d-flex align-items-center"
                                     data-background={process.env.PUBLIC_URL +"/img/slider/01-slide-1.jpg"}>
                                    <div className="container">
                                        <div className="row">
                                            <div className="col-xl-5">
                                                <div className="slider-content">
                                                    <div className="slider-top-btn" data-animation="fadeInLeft"
                                                         data-delay="1.5s">
                                                        <a href="product-details.html" className="st-btn b-radius">HOT
                                                            DEALS</a>
                                                    </div>
                                                    <h2 data-animation="fadeInLeft" data-delay="1.7s"
                                                        className="pt-15 slider-title pb-5">SALE 30% OFF <br/> FUTURE
                                                        FOOTBALL BOOTS</h2>
                                                    <p className="pr-20 slider_text" data-animation="fadeInLeft"
                                                       data-delay="1.9s">Discount 30% On Products &amp; Free
                                                        Shipping</p>
                                                    <div className="slider-bottom-btn mt-75">
                                                        <a data-animation="fadeInUp" data-delay="1.15s" href="shop.html"
                                                           className="st-btn-b b-radius">Discover now</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="single-slider swiper-slide slider-height d-flex align-items-center"
                                     data-background={process.env.PUBLIC_URL +"/img/slider/01-slide-2.jpg"}>
                                    <div className="container">
                                        <div className="row">
                                            <div className="col-xl-5">
                                                <div className="slider-content">
                                                    <div className="slider-top-btn" data-animation="fadeInLeft"
                                                         data-delay="1s">
                                                        <a href="product-details.html" className="st-btn b-radius">New
                                                            Arraivels</a>
                                                    </div>
                                                    <h2 data-animation="fadeInLeft" data-delay="1.5s"
                                                        className="pt-15 slider-title pb-5">SALE 20% OFF<br/> SAMSUNG
                                                        GALAXY BUDS </h2>
                                                    <p className="pr-20 slider_text" data-animation="fadeInLeft"
                                                       data-delay="1.7s">Discount 30% On Products &amp; Free
                                                        Shipping</p>
                                                    <div className="slider-bottom-btn mt-75">
                                            ...
                                            <div className="col-xl-5">
                                                <div className="slider-content">
                                                    ...
                                                    <h2 data-animation="fadeInLeft" data-delay="1.5s"
                                                        ...
                                                        FOOTBALL BOOTS</h2>
                                                    <p className="pr-20 slider_text" data-animation="fadeInLeft"
                                                       data-delay="1.8s">Discount 30% On Products &amp; Free
                                                        Shipping</p>
                                                    <div className="slider-bottom-btn mt-75">
                            ...
                            <div className="row">
                                <div className="col-xl-4 col-lg-4 col-md-6">
                                    <div className="banner__item p-relative w-img mb-30">
                                        <div className="banner__img">
                                            <a href="product-details.html"><img src={process.env.PUBLIC_URL +"/img/banner/banner-1.jpg"}
                                                                                alt=""/></a>
                                        </div>
                                        <div className="banner__content">
                                            <h6><a href="product-details.html">Intelligent <br/> New Touch Control</a>
                                            </h6>
                                ...
                                <div className="col-xl-4 col-lg-4 col-md-6">
                                    <div className="banner__item p-relative mb-30 w-img">
                                        <div className="banner__img">
                                            <a href="product-details.html"><img src={process.env.PUBLIC_URL +"/img/banner/banner-2.jpg"}
                                                                                alt=""/></a>
                                        </div>
                                        <div className="banner__content">
                                ...
                                <div className="col-xl-4 col-lg-4 col-md-6">
                                    <div className="banner__item p-relative mb-30 w-img">
                                        <div className="banner__img">
                                            <a href="product-details.html"><img src={process.env.PUBLIC_URL +"/img/banner/banner-3.jpg"}
                                                                                alt=""/></a>
                                        </div>
                                        <div className="banner__content">
                                            <h6><a href="product-details.html">Hot Sale <br/> Super Laptops 2022 </a>
                                            </h6>
                        ...
                        <div className="container">
                                ...
                                <div className="col-xl-12">
                                    <div className="section__head d-flex justify-content-between mb-10">
                                        ...
                                        <div className="offer-time">
                                            <span
                                                className="offer-title d-none d-sm-block">Hurry Up! Offer ends in:</span>
                                            <div className="countdown">
                                                <div className="countdown-inner b-radius" data-countdown
                            ...
                            <div className="row">
                                <div className="product-bs-slider">
                                        ...
                                        <div className="swiper-wrapper">
                                                ...
                                                <div className="product__thumb fix">
                                                    <div className="product-image w-img">
                                                        <a href="product-details.html">
                                                            <img src={process.env.PUBLIC_URL +"/img/product/tp-1.jpg"} alt="product"/>
                                                        </a>
                                                    </div>
                                            ...
                                            <div className="product__item swiper-slide">
                                                <div className="product__thumb fix">
                                                    <div className="product-image w-img">
                                                        <a href="product-details.html">
                                                            <img src={process.env.PUBLIC_URL +"/img/product/tp-2.jpg"} alt="product"/>
                                                        </a>
                                                    </div>
                                                    <div className="product-action">
                                                        <a href="#" className="icon-box icon-box-1"
                                            ...
                                            <div className="product__item swiper-slide">
                                                <div className="product__thumb fix">
                                                    <div className="product-image w-img">
                                                        <a href="product-details.html">
                                                            <img src={process.env.PUBLIC_URL +"/img/product/tp-3.jpg"} alt="product"/>
                                                        </a>
                                                    </div>
                                                    <div className="product__offer">
                                                ...
                                                <div className="product__content">
                                                    ...
                                                    <div className="progress mb-5">
                                                        <div className="progress-bar bg-danger" role="progressbar"
                                                             style={{width: '25%'}} aria-valuenow={100}
                                                             aria-valuemin={0} aria-valuemax={100}/>
                                                    </div>
                                                    <div className="progress-rate">
                                            ...
                                            <div className="product__item swiper-slide">
                                                <div className="product__thumb fix">
                                                    <div className="product-image w-img">
                                                        <a href="product-details.html">
                                                            <img src={process.env.PUBLIC_URL +"/img/product/tp-4.jpg"} alt="product"/>
                                                        </a>
                                                    </div>
                                                    <div className="product-action">
                                                        <a href="#" className="icon-box icon-box-1"
                                                ...
                                                <div className="product__content">
                                                    ...
                                                    <div className="progress mb-5">
                                                        <div className="progress-bar bg-danger" role="progressbar"
                                                             style={{width: '35%'}} aria-valuenow={100}
                                                             aria-valuemin={0} aria-valuemax={100}/>
                                                    </div>
                                                    <div className="progress-rate">
                                            ...
                                            <div className="product__item swiper-slide">
                                                <div className="product__thumb fix">
                                                    <div className="product-image w-img">
                                                        <a href="product-details.html">
                                                            <img src={process.env.PUBLIC_URL +"/img/product/tp-5.jpg"} alt="product"/>
                                                        </a>
                                                    </div>
                                                    <div className="product__offer">
                                            ...
                                            <div className="product__item swiper-slide">
                                                <div className="product__thumb fix">
                                                    <div className="product-image w-img">
                                                        <a href="product-details.html">
                                                            <img src={process.env.PUBLIC_URL +"/img/product/tp-6.jpg"} alt="product"/>
                                                        </a>
                                                    </div>
                                                    <div className="product-action">
                                                        <a href="#" className="icon-box icon-box-1"
                                    ...
                                    <div className="bs-button bs-button-next"><i className="fal fa-chevron-right"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-xl-6 col-lg-6 col-md-12">
                                    <div className="banner__item p-relative w-img mb-30">
                                        <div className="banner__img">
                                            <a href="product-details.html"><img src={process.env.PUBLIC_URL +"/img/banner/banner-4.jpg"}
                                                                                alt=""/></a>
                                        </div>
                                        <div className="banner__content">
                                ...
                                <div className="col-xl-6 col-lg-6 col-md-12">
                                    <div className="banner__item p-relative mb-30 w-img">
                                        <div className="banner__img">
                                            <a href="product-details.html"><img src={process.env.PUBLIC_URL +"/img/banner/banner-5.jpg"}
                                                                                alt=""/></a>
                                        </div>
                                        <div className="banner__content">
                                        ...
                                        <div className="product__nav-tab">
                                            <ul className="nav nav-tabs" id="flast-sell-tab" role="tablist">
                                                <li className="nav-item" role="presentation">
                                                    <button className="nav-link active" id="computer-tab"
                                                            data-bs-toggle="tab" data-bs-target="#computer"
                                                            type="button" role="tab" aria-controls="computer"
                                                            aria-selected="false">computer
                                                    </button>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <button className="nav-link" id="samsung-tab" data-bs-toggle="tab"
                                                            data-bs-target="#samsung" type="button" role="tab"
                                                            aria-selected="false">samsung
                                                    </button>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <button className="nav-link" id="htc-tab" data-bs-toggle="tab"
                                                            data-bs-target="#htc" type="button" role="tab"
                                                            aria-selected="false">HTC
                                                    </button>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <button className="nav-link" id="nokia-tab" data-bs-toggle="tab"
                                                            data-bs-target="#nokia" type="button" role="tab"
                                                            aria-selected="false">Nokia
                                                    </button>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <button className="nav-link" id="cell-tab" data-bs-toggle="tab"
                                                            data-bs-target="#cell" type="button" role="tab"
                                                            aria-selected="true">Cell Phones
                                                    </button>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div className="row">
                                <div className="col-xl-12">
                                    <div className="tab-content" id="flast-sell-tabContent">
                                        <div className="tab-pane fade active show" id="computer" role="tabpanel"
                                            ...
                                            <div className="product-bs-slider-2">
                                                    ...
                                                    <div className="swiper-wrapper">
                                                        <div className="product__item swiper-slide">
                                                            <div className="product__thumb fix">
                                                                <div className="product-image w-img">
                                                                    <a href="product-details.html">
                                                                        <img src={process.env.PUBLIC_URL +"/img/product/tp-1.jpg"}
                                                                             alt="product"/>
                                                                    </a>
                                                                </div>
                                                                <div className="product__offer">
                                                            ...
                                                            <div className="product__content">
                                                                <h6><a href="product-details.html">Epple iPad Pro
                                                                    10.5-inch Cellular 64G</a></h6>
                                                                <div className="rating mb-5">
                                                                    <ul>
                                                        ...
                                                        <div className="product__item swiper-slide">
                                                            <div className="product__thumb fix">
                                                                <div className="product-image w-img">
                                                                    <a href="product-details.html">
                                                                        <img src={process.env.PUBLIC_URL +"/img/product/tp-2.jpg"}
                                                                             alt="product"/>
                                                                    </a>
                                                                </div>
                                                                <div className="product-action">
                                                        ...
                                                        <div className="product__item swiper-slide">
                                                            <div className="product__thumb fix">
                                                                <div className="product-image w-img">
                                                                    <a href="product-details.html">
                                                                        <img src={process.env.PUBLIC_URL +"/img/product/tp-3.jpg"}
                                                                             alt="product"/>
                                                                    </a>
                                                                </div>
                                                                <div className="product__offer">
                                                        ...
                                                        <div className="product__item swiper-slide">
                                                            <div className="product__thumb fix">
                                                                <div className="product-image w-img">
                                                                    <a href="product-details.html">
                                                                        <img src={process.env.PUBLIC_URL +"/img/product/tp-4.jpg"}
                                                                             alt="product"/>
                                                                    </a>
                                                                </div>
                                                                <div className="product-action">
                                                        ...
                                                        <div className="product__item swiper-slide">
                                                            <div className="product__thumb fix">
                                                                <div className="product-image w-img">
                                                                    <a href="product-details.html">
                                                                        <img src={process.env.PUBLIC_URL +"/img/product/tp-5.jpg"}
                                                                             alt="product"/>
                                                                    </a>
                                                                </div>
                                                                <div className="product__offer">
                                                        ...
                                                        <div className="product__item swiper-slide">
                                                            <div className="product__thumb fix">
                                                                <div className="product-image w-img">
                                                                    <a href="product-details.html">
                                                                        <img src={process.env.PUBLIC_URL +"/img/product/tp-6.jpg"}
                                                                             alt="product"/>
                                                                    </a>
                                                                </div>
                                                                <div className="product-action">
                                                            ...
                                                            <div className="product__content">
                                                                <h6><a href="product-details.html">Vifa Bluetooth
                                                                    Portable Wireless Speaker</a></h6>
                                                                <div className="rating mb-5">
                                                                    <ul>
                                                                        <li><a href="#"><i className="fal fa-star"/></a>
                                                                        </li>
                                                ...
                                                <div className="bs-button bs2-button-prev"><i
                                                    className="fal fa-chevron-left"/></div>
                                                <div className="bs-button bs2-button-next"><i
                                                    className="fal fa-chevron-right"/></div>
                                            </div>
                                        </div>
                                        <div className="tab-pane fade" id="samsung" role="tabpanel"
                                        ...
                                        <div className="tab-pane fade" id="htc" role="tabpanel"
                                        ...
                                        <div className="tab-pane fade" id="nokia" role="tabpanel"
                                        ...
                                        <div className="tab-pane fade" id="cell" role="tabpanel"
                                ...
                                <div className="col-xl-12">
                                    <div className="section__head d-flex justify-content-between mb-30">
                                        ...
                                        <div className="button-wrap">
                                            <a href="shop.html">See All Product <i
                                                className="fal fa-chevron-right"/></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div className="features-thum">
                                                    <div className="features-product-image w-img">
                                                        <a href="product-details.html"><img
                                                            src={process.env.PUBLIC_URL +"/img/features-product/fpb-1.jpg"} alt=""/></a>
                                                    </div>
                                                    <div className="product__offer">
                                                        <span className="discount">-15%</span>
                                                    </div>
                                                    ...
                                                    <div className="features-des mb-25">
                                                        <ul>
                                                            <li><a href="product-details.html"><i
                                                                className="fas fa-circle"/> Bass and Stereo Sound.</a>
                                                            </li>
                                                            <li><a href="product-details.html"><i
                                                                className="fas fa-circle"/> Display with 3088 x 1440
                                                                pixels resolution.</a></li>
                                                            <li><a href="product-details.html"><i
                                                                className="fas fa-circle"/> Memory, Storage &amp; SIM:
                                                                12GB RAM, 256GB.</a></li>
                                                            <li><a href="product-details.html"><i
                                                                className="fas fa-circle"/> Androi v10.0 Operating
                                                                system.</a></li>
                                                        </ul>
                                                    </div>
                                                    <div className="cart-option">
                                                        <a href="cart.html" className="cart-btn-2 w-100 mr-10">Add to
                                                            Cart</a>
                                                        <a href="cart.html" className="transperant-btn"><i
                                                            className="fal fa-heart"/></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div className="row  g-0 align-items-center">
                                                    <div className="col-6">
                                                        <div className="features-thum">
                                                            <div className="features-product-image w-img">
                                                                <a href="product-details.html"><img
                                                                    src={process.env.PUBLIC_URL +"/img/features-product/fp-1.jpg"} alt=""/></a>
                                                            </div>
                                                            <div className="product__offer">
                                                                <span className="discount">-15%</span>
                                                            </div>
                                                    ...
                                                    <div className="col-6">
                                                        <div className="product__content product__content-d">
                                                            <h6><a href="product-details.html">Epple Watch SE Gold
                                                                Aluminum</a></h6>
                                                            <div className="rating mb-5">
                                                                <ul>
                                                                    <li><a href="#"><i className="fal fa-star"/></a>
                                                ...
                                                <div className="row  g-0 align-items-center">
                                                    <div className="col-6">
                                                        <div className="features-thum">
                                                            <div className="features-product-image w-img">
                                                                <a href="product-details.html"><img
                                                                    src={process.env.PUBLIC_URL +"/img/features-product/fp-2.jpg"} alt=""/></a>
                                                            </div>
                                                            <div className="product__offer">
                                                ...
                                                <div className="row  g-0 align-items-center">
                                                    <div className="col-6">
                                                        <div className="features-thum">
                                                            <div className="features-product-image w-img">
                                                                <a href="product-details.html"><img
                                                                    src={process.env.PUBLIC_URL +"/img/features-product/fp-3.jpg"} alt=""/></a>
                                                            </div>
                                                            <div className="product__offer">
                                                ...
                                                <div className="row  g-0 align-items-center">
                                                    <div className="col-6">
                                                        <div className="features-thum">
                                                            <div className="features-product-image w-img">
                                                                <a href="product-details.html"><img
                                                                    src={process.env.PUBLIC_URL +"/img/features-product/fp-4.jpg"} alt=""/></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-6">
                                                        <div className="product__content product__content-d">
                                                            <h6><a href="product-details.html">Men’s Short-Sleeve Pocket
                                                                Oxford Shirt</a></h6>
                                                            <div className="rating mb-5">
                                                                <ul>
                                                                    <li><a href="#"><i className="fal fa-star"/></a>
                    ...
                    <section className="moveing-text-area">
                        <div className="container">
                            <div className="ovic-running">
                                <div className="wrap">
                                    <div className="inner">
                                        <p className="item">Free UK Delivery - Return Over $100.00 ( Excluding Homeware
                                            ) | Free UK Collect From Store</p>
                                        <p className="item">Design Week / 15% Off the website / Code: AYOSALE-2020</p>
                                        <p className="item">Always iconic. Now organic. Introducing the $20 Organic
                                            Tee.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-xl-4 col-lg-6 col-md-12">
                                    <div className="banner__item p-relative w-img mb-30">
                                        <div className="banner__img">
                                            <a href="product-details.html"><img src={process.env.PUBLIC_URL +"/img/banner/banner-6.jpg"}
                                                                                alt=""/></a>
                                        </div>
                                        <div className="banner__content banner__content-sd text-center">
                                            ...
                                            <h6><a href="product-details.html">Sale 30% Off <br/> Top Computer Case
                                                Gaming</a></h6>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="row">
                                        <div className="col-md-12">
                                            <div className="banner__item p-relative mb-30 w-img">
                                                <div className="banner__img">
                                                    <a href="product-details.html"><img
                                                        src={process.env.PUBLIC_URL +"/img/banner/banner-7.jpg"} alt=""/></a>
                                                </div>
                                                <div className="banner__content banner__content-sd text-center">
                                                    ...
                                                    <div className="banner-button mt-20 d-none d-sm-block">
                                                        <a href="product-details.html" className="st-btn-3 b-radius">Shop
                                                            Deals</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-md-12">
                                            <div className="banner__item p-relative w-img mb-30">
                                                <div className="banner__img">
                                                    <a href="product-details.html"><img
                                                        src={process.env.PUBLIC_URL +"/img/banner/banner-8.jpg"} alt=""/></a>
                                                </div>
                                                <div className="banner__content">
                                                    <h6><a href="product-details.html">Hot Products <br/> Laptop Ultra
                                                        4K 16”</a></h6>
                                                    <p>Discount 20% On Products</p>
                                                </div>
                                            </div>
                                ...
                                <div className="col-xl-4 col-lg-6 col-md-12">
                                    <div className="banner__item p-relative mb-30 w-img">
                                        <div className="banner__img">
                                            <a href="product-details.html"><img src={process.env.PUBLIC_URL +"/img/banner/banner-9.jpg"}
                                                                                alt=""/></a>
                                        </div>
                                        <div className="banner__content banner__content-sd text-center">
                                            <div className="banner-button mb-20">
                                            ...
                                            <h6><a href="product-details.html">Sport Edition <br/> Best Choice of The
                                                Year</a></h6>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="swiper-wrapper">
                                            ...
                                            <div className="product__item mb-20 swiper-slide">
                                                <div className="product__thumb fix">
                                                    <div className="product-image w-img">
                                                        <a href="product-details.html">
                                                            <img src={process.env.PUBLIC_URL +"/img/product/tp-7.jpg"} alt="product"/>
                                                        </a>
                                                    </div>
                                                    <div className="product-action">
                                                        <a href="#" className="icon-box icon-box-1"
                                            ...
                                            <div className="product__item mb-20 swiper-slide">
                                                <div className="product__thumb fix">
                                                    <div className="product-image w-img">
                                                        <a href="product-details.html">
                                                            <img src={process.env.PUBLIC_URL +"/img/product/tp-10.jpg"} alt="product"/>
                                                        </a>
                                                    </div>
                                                    <div className="product-action">
                                                        <a href="#" className="icon-box icon-box-1"
                                            ...
                                            <div className="product__item mb-20 swiper-slide">
                                                <div className="product__thumb fix">
                                                    <div className="product-image w-img">
                                                        <a href="product-details.html">
                                                            <img src={process.env.PUBLIC_URL +"/img/product/tp-9.jpg"} alt="product"/>
                                                        </a>
                                                    </div>
                                                    <div className="product-action">
                                                        <a href="#" className="icon-box icon-box-1"
                                                ...
                                                <div className="product__content">
                                                    <h6><a href="product-details.html">Epple iPhone 11 Pro Max 64GB
                                                        Gold</a></h6>
                                                    <div className="rating mb-5">
                                                        <ul>
                                                            <li><a href="#"><i className="fal fa-star"/></a></li>
                            ...
                            <div className="brand-slider swiper-container pt-50 pb-45">
                                <div className="swiper-wrapper">
                                    <div className="brand-item w-img swiper-slide">
                                        <a href="#"><img src={process.env.PUBLIC_URL +"/img/brand/brand-1.jpg"} alt="brand"/></a>
                                    </div>
                                    <div className="brand-item w-img swiper-slide">
                                        <a href="#"><img src={process.env.PUBLIC_URL +"/img/brand/brand-2.jpg"} alt="brand"/></a>
                                    </div>
                                    <div className="brand-item w-img swiper-slide">
                                        <a href="#"><img src={process.env.PUBLIC_URL +"/img/brand/brand-3.jpg"} alt="brand"/></a>
                                    </div>
                                    <div className="brand-item w-img swiper-slide">
                                        <a href="#"><img src={process.env.PUBLIC_URL +"/img/brand/brand-4.jpg"} alt="brand"/></a>
                                    </div>
                                    <div className="brand-item w-img swiper-slide">
                                        <a href="#"><img src={process.env.PUBLIC_URL +"/img/brand/brand-5.jpg"} alt="brand"/></a>
                                    </div>
                                    <div className="brand-item w-img swiper-slide">
                                        <a href="#"><img src={process.env.PUBLIC_URL +"/img/brand/brand-6.jpg"} alt="brand"/></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-6">
                                    <div className="cta-item cta-item-d mb-30">
                                        ...
                                        <p>We make consolidating, marketing and tracking your social media website
                                            easy.</p>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="cta-item mb-30">
                                        ...
                                        <p>DukaMarket App is now available on App Store &amp; Google Play. Get it
                                            now.</p>
                                                ...
                                                <div className="product__modal-box">
                                                    <div className="tab-content" id="modalTabContent">
                                                        <div className="tab-pane fade show active" id="nav1"
                                                             role="tabpanel" aria-labelledby="nav1-tab">
                                                            <div className="product__modal-img w-img">
                                                                <img src={process.env.PUBLIC_URL +"/img/quick-view/quick-view-1.jpg"}
                                                                     alt=""/>
                                                            </div>
                                                        </div>
                                                        <div className="tab-pane fade" id="nav2" role="tabpanel"
                                                            ...
                                                            <div className="product__modal-img w-img">
                                                                <img src={process.env.PUBLIC_URL +"/img/quick-view/quick-view-2.jpg"}
                                                                     alt=""/>
                                                            </div>
                                                        </div>
                                                        <div className="tab-pane fade" id="nav3" role="tabpanel"
                                                            ...
                                                            <div className="product__modal-img w-img">
                                                                <img src={process.env.PUBLIC_URL +"/img/quick-view/quick-view-3.jpg"}
                                                                     alt=""/>
                                                            </div>
                                                        </div>
                                                        <div className="tab-pane fade" id="nav4" role="tabpanel"
                                                            ...
                                                            <div className="product__modal-img w-img">
                                                                <img src={process.env.PUBLIC_URL +"/img/quick-view/quick-view-4.jpg"}
                                                                     alt=""/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <ul className="nav nav-tabs" id="modalTab" role="tablist">
                                                        <li className="nav-item" role="presentation">
                                                            <button className="nav-link active" id="nav1-tab"
                                                                    ...
                                                                    aria-selected="true">
                                                                <img src={process.env.PUBLIC_URL +"/img/quick-view/quick-nav-1.jpg"}
                                                                     alt=""/>
                                                            </button>
                                                        </li>
                                                        <li className="nav-item" role="presentation">
                                                            <button className="nav-link" id="nav2-tab"
                                                                    data-bs-toggle="tab" data-bs-target="#nav2"
                                                                    type="button" role="tab" aria-controls="nav2"
                                                                    aria-selected="false">
                                                                <img src={process.env.PUBLIC_URL +"/img/quick-view/quick-nav-2.jpg"}
                                                                     alt=""/>
                                                            </button>
                                                        </li>
                                                        <li className="nav-item" role="presentation">
                                                            <button className="nav-link" id="nav3-tab"
                                                                    data-bs-toggle="tab" data-bs-target="#nav3"
                                                                    type="button" role="tab" aria-controls="nav3"
                                                                    aria-selected="false">
                                                                <img src={process.env.PUBLIC_URL +"/img/quick-view/quick-nav-3.jpg"}
                                                                     alt=""/>
                                                            </button>
                                                        </li>
                                                        <li className="nav-item" role="presentation">
                                                            <button className="nav-link" id="nav4-tab"
                                                                    data-bs-toggle="tab" data-bs-target="#nav4"
                                                                    type="button" role="tab" aria-controls="nav4"
                                                                    aria-selected="false">
                                                                <img src={process.env.PUBLIC_URL +"/img/quick-view/quick-nav-4.jpg"}
                                                                     alt=""/>
                                                            </button>
                                                        </li>
                                                    </ul>
                                            ...
                                            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div className="product__modal-content">
                                                    ...
                                                    <div className="product__modal-des mt-20 mb-15">
                                                        <ul>
                                                            <li><a href="#"><i className="fas fa-circle"/> Bass and
                                                                Stereo Sound.</a></li>
                                                            <li><a href="#"><i className="fas fa-circle"/> Display with
                                                        ...
                                                        <form action="#">
                                                            <div className="pro-quan-area d-lg-flex align-items-center">
                                                                ...
                                                                <div className="pro-cart-btn mb-25">
                                                                    <button className="cart-btn" type="submit">Add to
                                                                        cart
                                                                    </button>
                                                                </div>
                                                            </div>
